...
final class KeyboardInputStateTest {
    ...
    void forwardsKeyDownAndMatchingKeyUpSignals() {
        ...
        assertEquals(List.of("computer.checked_signal", "key_down", 'a', 30), node.signals.get(0));
        assertEquals(List.of("computer.checked_signal", "key_up", 'a', 30), node.signals.get(1));
    }
    ...
    void forwardsClipboardLines() {
        ...
        assertEquals(2, node.signals.size());
        assertEquals(List.of("computer.checked_signal", "clipboard", "alpha"), node.signals.get(0));
        assertEquals(List.of("computer.checked_signal", "clipboard", "beta"), node.signals.get(1));
    }
