...
final class UpgradeVisibilityParityTest {
    @Test
    void pistonComponentIsNetworkVisibleLikeUpstreamUpgrade() {
        OpenComputersApi.initialize();

        TestAgent host = new TestAgent();
        PistonUpgradeEnvironment environment = new PistonUpgradeEnvironment(host, host);
    ...
    @Test
    void tradingComponentIsNetworkVisibleLikeUpstreamUpgrade() {
        OpenComputersApi.initialize();

        TradingUpgradeEnvironment environment = new TradingUpgradeEnvironment(new TestAgent());
    ...
    @Test
    void tractorBeamComponentIsNetworkVisibleLikeUpstreamUpgrade() {
        OpenComputersApi.initialize();

        TractorBeamUpgradeEnvironment environment = new TractorBeamUpgradeEnvironment(new TestAgent());
        Component component = assertInstanceOf(Component.class, environment.node());
