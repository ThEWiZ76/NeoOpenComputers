...
final class ModContentRegistrationTest {
    ...
    @Test
    void terminalItemIdIsStable() {
        assertEquals("terminal", ModContentIds.TERMINAL);
    }
    ...
    @Test
    void powerConverterBlockIdIsStable() {
        assertEquals("power_converter", ModContentIds.POWER_CONVERTER);
    }
    ...
    @Test
    void chargerBlockEntityIdIsStable() {
        assertEquals("charger", ModContentIds.CHARGER_BLOCK_ENTITY);
    }

    @Test
    void chargerMenuIdIsStable() {
        assertEquals("charger", ModContentIds.CHARGER_MENU);
    }
    ...
    @Test
    void driveMenuIdIsStable() {
        assertEquals("drive", ModContentIds.DRIVE_MENU);
    }
    ...
    @Test
    void terminalMenuIdIsStable() {
        assertEquals("terminal", ModContentIds.TERMINAL_MENU);
    }
}
