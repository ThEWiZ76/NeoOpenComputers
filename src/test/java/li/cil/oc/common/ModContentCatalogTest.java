...
final class ModContentCatalogTest {
    ...
    void registersMaterialApiItemNames() {
        ...
        assertNotNull(registry.get(ModContentCatalog.COMPAT_COMPONENT_BUS_TIER1_UPSTREAM));
        assertNotNull(registry.get(ModContentCatalog.COMPAT_COMPONENT_BUS_TIER2_UPSTREAM));
        assertNotNull(registry.get(ModContentCatalog.COMPAT_COMPONENT_BUS_TIER3_UPSTREAM));
        ...
        assertEquals(ModContentCatalog.COMPAT_COMPONENT_BUS_TIER1_UPSTREAM, registry.get(ModContentCatalog.COMPAT_COMPONENT_BUS_TIER1_UPSTREAM).name());
        assertEquals(ModContentCatalog.COMPAT_COMPONENT_BUS_TIER2_UPSTREAM, registry.get(ModContentCatalog.COMPAT_COMPONENT_BUS_TIER2_UPSTREAM).name());
        assertEquals(ModContentCatalog.COMPAT_COMPONENT_BUS_TIER3_UPSTREAM, registry.get(ModContentCatalog.COMPAT_COMPONENT_BUS_TIER3_UPSTREAM).name());
    ...
    void registersInitialApiItemNames() throws ReflectiveOperationException {
        ...
        assertNotNull(registry.get(ModContentCatalog.COMPAT_INVENTORY_CONTROLLER_UPGRADE_UPSTREAM));
        ...
        assertNotNull(registry.get(ModContentCatalog.COMPAT_REDSTONE_CARD_TIER1_UPSTREAM));
        ...
        assertNotNull(registry.get(ModContentCatalog.COMPAT_BATTERY_UPGRADE_TIER1_UPSTREAM));
        assertNotNull(registry.get(ModContentCatalog.COMPAT_BATTERY_UPGRADE_TIER2_UPSTREAM));
        assertNotNull(registry.get(ModContentCatalog.COMPAT_BATTERY_UPGRADE_TIER3_UPSTREAM));
        assertNotNull(registry.get(ModContentCatalog.COMPAT_DATABASE_UPGRADE_TIER1_UPSTREAM));
        assertNotNull(registry.get(ModContentCatalog.COMPAT_DATABASE_UPGRADE_TIER2_UPSTREAM));
        assertNotNull(registry.get(ModContentCatalog.COMPAT_DATABASE_UPGRADE_TIER3_UPSTREAM));
        assertNotNull(registry.get(ModContentCatalog.COMPAT_INVENTORY_UPGRADE_UPSTREAM));
        assertNotNull(registry.get(ModContentCatalog.COMPAT_CRAFTING_UPGRADE_UPSTREAM));
        assertNotNull(registry.get(ModContentCatalog.COMPAT_EXPERIENCE_UPGRADE_UPSTREAM));
        assertNotNull(registry.get(ModContentCatalog.COMPAT_PISTON_UPGRADE_UPSTREAM));
        assertNotNull(registry.get(ModContentCatalog.COMPAT_STICKY_PISTON_UPGRADE_UPSTREAM));
        assertNotNull(registry.get(ModContentCatalog.COMPAT_SIGN_UPGRADE_UPSTREAM));
        assertNotNull(registry.get(ModContentCatalog.COMPAT_TRADING_UPGRADE_UPSTREAM));
        assertNotNull(registry.get(ModContentCatalog.COMPAT_TRACTOR_BEAM_UPGRADE_UPSTREAM));
        assertNotNull(registry.get(ModContentCatalog.COMPAT_LEASH_UPGRADE_UPSTREAM));
        assertNotNull(registry.get(ModContentCatalog.COMPAT_ANGEL_UPGRADE_UPSTREAM));
        assertNotNull(registry.get(ModContentCatalog.COMPAT_CHUNKLOADER_UPGRADE_UPSTREAM));
        assertNotNull(registry.get(ModContentCatalog.COMPAT_HOVER_UPGRADE_TIER1_UPSTREAM));
        assertNotNull(registry.get(ModContentCatalog.COMPAT_HOVER_UPGRADE_TIER2_UPSTREAM));
        assertNotNull(registry.get(ModContentCatalog.COMPAT_GENERATOR_UPGRADE_UPSTREAM));
        assertNotNull(registry.get(ModContentCatalog.COMPAT_SOLAR_GENERATOR_UPGRADE_UPSTREAM));
        assertNotNull(registry.get(ModContentCatalog.COMPAT_TANK_UPGRADE_UPSTREAM));
        assertNotNull(registry.get(ModContentCatalog.COMPAT_TANK_CONTROLLER_UPGRADE_UPSTREAM));
        ...
        assertEquals(ModContentCatalog.COMPAT_INVENTORY_CONTROLLER_UPGRADE_UPSTREAM, registry.get(ModContentCatalog.COMPAT_INVENTORY_CONTROLLER_UPGRADE_UPSTREAM).name());
        ...
        assertEquals(ModContentCatalog.COMPAT_REDSTONE_CARD_TIER1_UPSTREAM, registry.get(ModContentCatalog.COMPAT_REDSTONE_CARD_TIER1_UPSTREAM).name());
        ...
        assertEquals(ModContentCatalog.COMPAT_BATTERY_UPGRADE_TIER1_UPSTREAM, registry.get(ModContentCatalog.COMPAT_BATTERY_UPGRADE_TIER1_UPSTREAM).name());
        assertEquals(ModContentCatalog.COMPAT_BATTERY_UPGRADE_TIER2_UPSTREAM, registry.get(ModContentCatalog.COMPAT_BATTERY_UPGRADE_TIER2_UPSTREAM).name());
        assertEquals(ModContentCatalog.COMPAT_BATTERY_UPGRADE_TIER3_UPSTREAM, registry.get(ModContentCatalog.COMPAT_BATTERY_UPGRADE_TIER3_UPSTREAM).name());
        assertEquals(ModContentCatalog.COMPAT_DATABASE_UPGRADE_TIER1_UPSTREAM, registry.get(ModContentCatalog.COMPAT_DATABASE_UPGRADE_TIER1_UPSTREAM).name());
        assertEquals(ModContentCatalog.COMPAT_DATABASE_UPGRADE_TIER2_UPSTREAM, registry.get(ModContentCatalog.COMPAT_DATABASE_UPGRADE_TIER2_UPSTREAM).name());
        assertEquals(ModContentCatalog.COMPAT_DATABASE_UPGRADE_TIER3_UPSTREAM, registry.get(ModContentCatalog.COMPAT_DATABASE_UPGRADE_TIER3_UPSTREAM).name());
        assertEquals(ModContentCatalog.COMPAT_INVENTORY_UPGRADE_UPSTREAM, registry.get(ModContentCatalog.COMPAT_INVENTORY_UPGRADE_UPSTREAM).name());
        assertEquals(ModContentCatalog.COMPAT_CRAFTING_UPGRADE_UPSTREAM, registry.get(ModContentCatalog.COMPAT_CRAFTING_UPGRADE_UPSTREAM).name());
        assertEquals(ModContentCatalog.COMPAT_EXPERIENCE_UPGRADE_UPSTREAM, registry.get(ModContentCatalog.COMPAT_EXPERIENCE_UPGRADE_UPSTREAM).name());
        assertEquals(ModContentCatalog.COMPAT_PISTON_UPGRADE_UPSTREAM, registry.get(ModContentCatalog.COMPAT_PISTON_UPGRADE_UPSTREAM).name());
        assertEquals(ModContentCatalog.COMPAT_STICKY_PISTON_UPGRADE_UPSTREAM, registry.get(ModContentCatalog.COMPAT_STICKY_PISTON_UPGRADE_UPSTREAM).name());
        assertEquals(ModContentCatalog.COMPAT_SIGN_UPGRADE_UPSTREAM, registry.get(ModContentCatalog.COMPAT_SIGN_UPGRADE_UPSTREAM).name());
        assertEquals(ModContentCatalog.COMPAT_TRADING_UPGRADE_UPSTREAM, registry.get(ModContentCatalog.COMPAT_TRADING_UPGRADE_UPSTREAM).name());
        assertEquals(ModContentCatalog.COMPAT_TRACTOR_BEAM_UPGRADE_UPSTREAM, registry.get(ModContentCatalog.COMPAT_TRACTOR_BEAM_UPGRADE_UPSTREAM).name());
        assertEquals(ModContentCatalog.COMPAT_LEASH_UPGRADE_UPSTREAM, registry.get(ModContentCatalog.COMPAT_LEASH_UPGRADE_UPSTREAM).name());
        assertEquals(ModContentCatalog.COMPAT_ANGEL_UPGRADE_UPSTREAM, registry.get(ModContentCatalog.COMPAT_ANGEL_UPGRADE_UPSTREAM).name());
        assertEquals(ModContentCatalog.COMPAT_CHUNKLOADER_UPGRADE_UPSTREAM, registry.get(ModContentCatalog.COMPAT_CHUNKLOADER_UPGRADE_UPSTREAM).name());
        assertEquals(ModContentCatalog.COMPAT_HOVER_UPGRADE_TIER1_UPSTREAM, registry.get(ModContentCatalog.COMPAT_HOVER_UPGRADE_TIER1_UPSTREAM).name());
        assertEquals(ModContentCatalog.COMPAT_HOVER_UPGRADE_TIER2_UPSTREAM, registry.get(ModContentCatalog.COMPAT_HOVER_UPGRADE_TIER2_UPSTREAM).name());
        assertEquals(ModContentCatalog.COMPAT_GENERATOR_UPGRADE_UPSTREAM, registry.get(ModContentCatalog.COMPAT_GENERATOR_UPGRADE_UPSTREAM).name());
        assertEquals(ModContentCatalog.COMPAT_SOLAR_GENERATOR_UPGRADE_UPSTREAM, registry.get(ModContentCatalog.COMPAT_SOLAR_GENERATOR_UPGRADE_UPSTREAM).name());
        assertEquals(ModContentCatalog.COMPAT_TANK_UPGRADE_UPSTREAM, registry.get(ModContentCatalog.COMPAT_TANK_UPGRADE_UPSTREAM).name());
