...
final class ModSettingsTest {
    ...
    void mfuSettingsExposeUpstreamDefaultsWhenConfigIsUnloaded() {
        ...
        assertEquals(200D, ModSettings.chargerRate());
        assertEquals(100D, ModSettings.chargerChargeRate());
        assertEquals(10D, ModSettings.chargerChargeRateTablet());
        ...
        assertEquals(false, ModSettings.enableInventoryDriver());
        ...
        assertEquals(0.5D, ModSettings.gpuBitbltCost(), 0.000_001D);
    ...
    void mfuConfigUsesUpstreamCompatiblePaths() {
        ...
        assertEquals(List.of("power", "rate", "charger"), ModSettings.CHARGER_RATE.getPath());
        assertEquals(List.of("power", "chargerChargeRate"), ModSettings.CHARGER_CHARGE_RATE.getPath());
        assertEquals(List.of("power", "chargerChargeRateTablet"), ModSettings.CHARGER_CHARGE_RATE_TABLET.getPath());
        ...
        assertEquals(List.of("gpu", "bitbltCost"), ModSettings.GPU_BITBLT_COST.getPath());
        ...
        assertEquals(List.of("integration", "vanilla", "enableInventoryDriver"), ModSettings.ENABLE_INVENTORY_DRIVER.getPath());
