...
Das Schwebe-Upgrade erlaubt es Robotern viel höher über dem Boden zu fliegen als normal. Im Gegensatz zu Drohnen können diese nämlich standardmäßig nur 8 Block hoch schweben. Das ist normal kein großes Problem, da sie sich trotzdem an Wänden entlang bewegen können. Sie können sich so bewegen:
...
![Bewegungsregeln der Roboter zusammengefasst.](neoopencomputers:doc/img/robotMovement.png)
