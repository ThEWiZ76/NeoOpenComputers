...
Die Seiten sind aus Sicht des Gerätes (also dem [Computergehäuse](../block/case1.md) / Roboter / [Serverschrank](../block/serverRack.md)) zu sehen. Mit Blick auf die Vorderseite ist `sides.right` also auf der linken Seite und andersrum.
