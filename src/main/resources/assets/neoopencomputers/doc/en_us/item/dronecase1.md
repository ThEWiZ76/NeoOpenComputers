...
Like microcontrollers, drones can only be programmed using their [EEPROM](eeprom.md). Accordingly, the [EEPROM](eeprom.md) can be changed by crafting the drone with another [EEPROM](eeprom.md); the existing [EEPROM](eeprom.md) is return to the player's inventory.
