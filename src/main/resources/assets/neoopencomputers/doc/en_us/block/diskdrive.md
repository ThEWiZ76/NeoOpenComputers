...
It can also be installed in robots to allow inserting [floppy disks](../item/floppy.md) into the robot. This can be very useful since the only other way to transfer data to and from a robot is using networking - for example using [network cards](../item/lanCard.md).
