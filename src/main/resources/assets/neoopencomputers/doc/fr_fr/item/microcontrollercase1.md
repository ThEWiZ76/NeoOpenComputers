...
Le boitier de microcontrôleur est la base de construction des microcontrôleurs grâce à l'[assembleur](../block/assembler.md). Les microcontrôleurs sont des [ordinateurs](../general/computer.md) très primitifs. Ils peuvent seulement contenir une quantité très limitée de composants, et sont faits pour être avoir une utilisation très spécifique, comme la transformation de signaux de redstone, ou le traitement de messages réseaux.

Un microcontrôleur n'a pas vraiment de système de fichier. Toute la programmation doit être faite dans la puce [EEPROM](eeprom.md). La puce peut être échangée avec une autre en re-fabriquant le microcontrôleur avec cette puce. L'ancienne [EEPROM](eeprom.md) sera rendue dans l'inventaire du joueur.
