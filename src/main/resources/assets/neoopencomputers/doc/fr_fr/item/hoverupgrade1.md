...
L'amélioration de vol plané permet aux robots de voler beaucoup plus au dessus du sol que ce qu'ils pourraient le faire normalement. Contrairement aux drones, ils sont limités par défaut à une hauteur de vol de 8 blocs. Ca n'est généralement pas un problème, parce qu'ils peuvent tout de même monter aux murs. Leurs règles de déplacement peuvent être résumées ainsi :
...
![Visualisation des règles de déplacement des robots.](neoopencomputers:doc/img/robotMovement.png)
