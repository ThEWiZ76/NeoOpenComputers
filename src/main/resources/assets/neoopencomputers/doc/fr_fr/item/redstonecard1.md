...
Le côté renseigné dans les méthodes de la carte est relatif à l'orientation du [boîtier d'ordinateur](../block/case1.md) / robot / [support de serveur](../block/rack.md). Cela signifie que quand vous regardez l'avant d'un ordinateur, le côté `sides.right` est à votre gauche, et inversement.
