...
OpenOS устанавливается командой `install`, после чего потребуется подтверждение установки. [Дискету](../item/floppy.md) можно вытащить после установки системы и перезапуска компьютера. OpenOS можно установить на все устройства, кроме дронов и микроконтроллеров (они могут быть запрограммированы только с помощью [EEPROM](../item/eeprom.md), так как они не имеют собственной файловой системы).
