...
Это улучшение позволяет роботам летать гораздо выше над землёю, чем обычно. В отличие от дронов, максимальная высота их полета ограничена 8 блоками по умолчанию. Обычно это не доставляет больших проблем, потому что они все также могут двигаться по стенам и просто вверх. Правила их передвижения могут быть сведены к следующему:
...
![Визуализация правил передвижения роботов.](neoopencomputers:doc/img/robotMovement.png)
