...
Сторона сигнала считается относительно ориентации [системного блока](../block/case1.md), робота или [серверной стойки](../block/rack.md). Это означает, что если вы смотрите на компьютер спереди, `sides.right` будет слева от вас и наоборот..
