...
Зарядное устройство предназначено для зарядки устройств, таких как роботы, дроны и [планшеты](../item/tablet.md). Зарядное устройство активируется редстоун-сигналом. Скорость заряда зависит от силы редстоун-сигнала: так, при силе 15, скорость заряда будет 100%.
