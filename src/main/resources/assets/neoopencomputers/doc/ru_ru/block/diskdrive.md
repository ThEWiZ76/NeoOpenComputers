...
Он может быть также установлен в роботов, чтобы они получили возможность использовать [дискеты](../item/floppy.md). Это может быть очень полезным, потому что, помимо дискет, передать информацию на робота и обратно можно только по сети (например, с помощью [сетевых карт](../item/lanCard.md)).
