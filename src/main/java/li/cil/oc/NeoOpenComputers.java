...
import li.cil.oc.common.component.ChunkloaderUpgradeHandler;
...
import li.cil.oc.common.network.DroneNetworking;
...
import li.cil.oc.common.network.RobotNetworking;
...
public final class NeoOpenComputers {
    ...
    public NeoOpenComputers(final IEventBus modEventBus, final ModContainer modContainer) {
        ...
        modEventBus.addListener(DroneNetworking::register);
        ...
        modEventBus.addListener(RobotNetworking::register);
