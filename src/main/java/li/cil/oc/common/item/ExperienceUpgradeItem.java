...
public class ExperienceUpgradeItem extends Item implements HostAware {
    public ExperienceUpgradeItem(final Properties properties) {
        super(properties);
    }
    ...
    public ManagedEnvironment createEnvironment(final ItemStack stack, final EnvironmentHost host) {
        return host instanceof Agent agent ? new ExperienceUpgradeEnvironment(agent) : null;
    }
