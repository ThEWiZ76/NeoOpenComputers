...
public final class ModContentIds {
    ...
    public static final String ADAPTER_MENU = "adapter";
    ...
    public static final String DRONE_CASE_TIER1 = "drone_case_tier1";
    ...
    public static final String DIAMOND_CHIP = "diamond_chip";
    ...
    public static final String RELAY_BLOCK_ENTITY = "relay";
    ...
    public static final String WAYPOINT_MENU = "waypoint";
