    ...
    public static void registerDefaults() {
        if (API.driver instanceof DriverRegistry registry) {
            ...
            register(
                ...
                ModItems.PISTON_UPGRADE.get(), ModItems.STICKY_PISTON_UPGRADE.get(), ModItems.SIGN_UPGRADE.get(), ModItems.TRADING_UPGRADE.get(), ModItems.TRACTOR_BEAM_UPGRADE.get(), ModItems.LEASH_UPGRADE.get(),
