...
public final class ModDriverCatalog {
    public static void registerDefaults() {
        if (API.driver instanceof DriverRegistry registry) {
            registerBlocks(registry, new BeaconBlockDriver(), new BrewingStandBlockDriver(), new ComputerCaseBlockDriver(), new ComparatorBlockDriver(), new DiskDriveBlockDriver(), new FurnaceBlockDriver(), new InventoryBlockDriver(), new MobSpawnerBlockDriver(), new NoteBlockDriver(), new ScreenBlockDriver());
